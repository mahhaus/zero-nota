...
/**
 * Created by josias.soares on 05/02/2018.
 * 16:47
 */

public class MapperSP implements INFCe {
    private static final String TAG = MapperSP.class.getSimpleName();
...
//            lNotaFiscal.setCnpj(cabecalho.first().children().get(1).ownText()
//                    .replaceAll("\n", "")
//                    .replaceAll("\r", "")
//                    .trim());
//            lNotaFiscal.setEndereco(cabecalho.first().children().get(2).ownText()
//                    .replaceAll("\n", "")
//                    .replaceAll("\r", "")
//                    .trim());
//
...
////
////            for (Element e : totalNota.getAllElements().first().children()) {
////                if (!e.getAllElements().hasClass("txtMax2")) {
////                    if (e.getAllElements().hasClass("tx")) {
